...
public class EmotivCtrl : MonoBehaviour
{
	...
	*/
    ...
    public void TrainPush()
    {
        ...
        uint push = (uint)EdkDll.IEE_MentalCommandAction_t.MC_PUSH;
        EmoEngine.Instance.MentalCommandSetActiveActions(0, push);


        engine.MentalCommandSetActiveActions(0, (uint)EdkDll.IEE_MentalCommandAction_t.MC_PUSH);
        engine.MentalCommandSetTrainingControl((uint)engineUserID, EdkDll.IEE_MentalCommandTrainingControl_t.MC_START);
    }

    public void TrainNeutral()
    {
        uint neutral = (uint)EdkDll.IEE_MentalCommandAction_t.MC_NEUTRAL;
        EmoEngine.Instance.MentalCommandSetActiveActions(0, neutral);
        engine.MentalCommandSetActiveActions(0, (uint)EdkDll.IEE_MentalCommandAction_t.MC_NEUTRAL);
        engine.MentalCommandSetTrainingControl((uint)engineUserID, EdkDll.IEE_MentalCommandTrainingControl_t.MC_START);
    }
